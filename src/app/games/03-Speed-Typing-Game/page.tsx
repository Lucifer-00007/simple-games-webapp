...
const SpeedTypingGame = () => {
  ...
  return (
    <>
      <main>
        <div className="quote-display" id="quoteDisplay"><span></span></div>
        <section className="typing">
          <hr />
          <div className="score">
            <div className="timer">
              <span className="timer__label">Time:</span>
              <span className="timer__text" id="timer">0</span>
            </div>
            <div className="words-per-minute">
              <span className="words-per-minute__label">Words/min:</span>
              <span className="words-per-minute__text" id="wpm">0</span>
            </div>
          </div>
          <textarea className="quote-input" name="quoteInput" id="quoteInput" placeholder="Start typing right here!" cdkfocusinitial=""></textarea>
        </section>
      </main>
      <style jsx>{`
