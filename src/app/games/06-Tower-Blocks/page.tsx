...
const TowerBlocksGame = () => {
  useEffect(() => {
    ...
    script1.src = 'https://cdnjs.cloudflare.com/ajax/libs/three.js/r83/three.min.js';
    document.body.appendChild(script1);

    const script2 = document.createElement('script');
    script2.src = 'https://cdnjs.cloudflare.com/ajax/libs/gsap/latest/TweenMax.min.js';
