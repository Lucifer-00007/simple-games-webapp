...
const ArcheryGame = () => {
  useEffect(() => {
    ...
    script1.src = 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.1/TweenMax.min.js';
    document.body.appendChild(script1);

    const script2 = document.createElement('script');
    script2.src = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/MorphSVGPlugin.min.js';
  ...
  return (
    <>
      <svg id="game" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 400" overflow="visible">
        ...
        <g className="arrow-angle"><use x="100" y="250" xlinkHref="#arrow" /></g>
        <clipPath id="mask">
