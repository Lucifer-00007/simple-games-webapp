  ...
  useEffect(() => {
    const quizGame = () => {
      ...
      function checkAnswer() {
        ...
        if (selectedOption) {
          const answer = (selectedOption as HTMLInputElement).value;
  ...
  return (
    <>
      <div className="container">
        <h1 style={{ marginBottom: "2px" }}>Quiz App</h1>
        <h4 style={{ marginTop: "0px" }}>20 Questions</h4>
        <div id="quiz"></div>
        <div id="result" className="result"></div>
        <button id="submit" className="button">Submit</button>
        <button id="retry" className="button hide">Retry</button>
        <button id="showAnswer" className="button hide">Show Answer</button>
      </div>
      <style jsx>{`
